...
import math,sys
if len(sys.argv)!=3: raise SystemExit('usage: verify_26613_v1_regressions.py BASE CANDIDATE')
...
print('PASS 26613 permanent regressions: no quantile authority / fixed-domain identity / direct HDR / 26611 freeze / physical support / real-color veto')
