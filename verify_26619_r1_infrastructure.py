...
import hashlib,sys
if len(sys.argv)<3: raise SystemExit('usage: verify_26619_r1_infrastructure.py BUILD WORKFLOW [--success-26618-script P --success-26618-workflow P --success-26618-transform P]')
...
assert 'IrisCamera-${VERSION_NAME}-${VERSION_BUILD}-r1-monotonic-guided-base-detail-debug.apk' in b
assert 'IrisCamera-0.9726619-26619-r1-monotonic-guided-base-detail-debug.apk' in w
...
for required in ["'R1_26619_*'","'verify_26619_r1_*.py'","'handoff_payload_26619/**'","'build_26619_r1_monotonic_guided_base_detail_ltm.sh'"]:
    assert required in push,required
t=(bp.parent/'transform_26619_r1.py').read_text()
...
print('PASS 26619 infrastructure: exact successful-26618 ordering/isolation/compiler/NDK/patch/assemble/invariance mechanics preserved; identity/authority/count/algorithm validators only')
