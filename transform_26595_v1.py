...
pre=read(pkg/'V1_26595_PREWRITE_SOURCE_HASHES.sha256');exp=read(pkg/'V1_26595_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
if list(pre)!=CHANGED or list(exp)!=CHANGED: fail('manifest allowlist mismatch')
payload=pkg/'handoff_payload_26595_v1'
...
print('PASS exact successful-26594 compiled-candidate authority + exact three-file 26595 phase-coherent SHORT/SR overlay')
