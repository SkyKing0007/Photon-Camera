...
pre=read(pkg/'V1_26589_PREWRITE_SOURCE_HASHES.sha256');exp=read(pkg/'V1_26589_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
...
payload=pkg/'handoff_payload_26589_v1'
for r in CHANGED:
 src=payload/r
...
print('PASS exact successful 26588 compiled-candidate authority + two-file 26589 V1 payload overlay')
