...
if len(sys.argv)!=3:raise SystemExit("usage: verify_26707_regressions.py BASE26706 CANDIDATE")
...
print('PASS 26707 permanent regressions: exact 5-file scope; blue-speck rejection + absolute 0/0.67/1.33EV NORMAL protection + 26705 cold-start convergence + NORMAL-only moving-tail rejection; 26706 tone/UHDR protected')
