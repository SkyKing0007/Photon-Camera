...
EXPECTED_INFRA_PARENT="739a6afc4bfeafc5f3d6a4cb731b7c0b203c1938"
...
TRANSFORM_SCRIPT="transform_26477_strict_wronski_authority_v2.py"
...
exec > >(tee "$AUDIT") 2>&1
echo "=== 26477 V2 STRICT WRONSKI RECONSTRUCTION AUTHORITY ==="
date -Iseconds || true

BRANCH="${GITHUB_REF_NAME:-$(git branch --show-current)}"
[[ "$BRANCH" == "$EXPECTED_BRANCH" ]] || fail "wrong branch: $BRANCH"
[[ "$(git rev-parse HEAD^)" == "$EXPECTED_INFRA_PARENT" ]] || fail "26477 V2 infrastructure parent is not exact 26477 V1 infrastructure commit"
