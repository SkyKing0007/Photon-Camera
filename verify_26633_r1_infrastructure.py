...
import sys
if len(sys.argv)!=3: raise SystemExit('usage: verify_26633_r1_infrastructure.py BUILD WORKFLOW')
...
'R1_26633_RUNTIME_DELTA_FROM_26632_R1.patch','R1_26633_RUNTIME_ROLLBACK_TO_26632_R1.patch',
...
if 'core.abbrev=7/12/40' not in (root/'verify_26633_r1_patches.py').read_text(): raise SystemExit('FAIL deterministic patch mechanics text')
...
if w.count('bash build_26633_r1_short_shadow_luma.sh')!=1: raise SystemExit('FAIL workflow build invocation count')
print('PASS 26633 infrastructure: exact successful-26631 ordering/isolation/compiler/NDK/patch/PRE-BUILD/assemble/postbuild mechanics preserved; identity/26632 authority/5-path validators/new regressions only')
