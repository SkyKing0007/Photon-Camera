...
public class PostPipeline extends GLBasePipeline {
            ...
            try {
                com.particlesdevs.photoncamera.util.MotionTrace.processingState(
                        ...
                        "attached=" + attached
                                ...
                                + " hdrMasterOwner=POST_VGN_EXTENDED_LINEAR"
                                + " maxRatio=" + motionV2GainMapMaxRatio
                                + " fullHdrDisplayRatio=" + motionV2GainMapFullHdrDisplayRatio
                                + " capacityMatchesGainMapMax=true");
    ...
    private void BuildDefaultPipeline() {
        ...
        if(mParameters.irisNightActive){
            ...
            /* IRIS_26638_ACR3_SINGLE_COLOR_APPEARANCE_OWNER
             * MotionV2ColorTransform now owns the default photographic RGB relationship. The old
             * 0.95 contraction/recovery stage must remain unreachable so color is rendered once.
             */
            add(new StageTelemetry("IRIS_26638_NIGHT_ACR3_COLOR_APPEARANCE"));
