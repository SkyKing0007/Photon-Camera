...
pre=read(pkg/'V1_26597_PREWRITE_SOURCE_HASHES.sha256');exp=read(pkg/'V1_26597_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
if list(pre)!=CHANGED or list(exp)!=CHANGED: fail('manifest allowlist mismatch')
payload=pkg/'handoff_payload_26597_v1'
...
print('PASS exact successful-26596 compiled-candidate authority + exact four-file 26597 universal highlight overlay')
