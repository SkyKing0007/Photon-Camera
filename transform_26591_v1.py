...
pre=read(pkg/'V1_26591_PREWRITE_SOURCE_HASHES.sha256');exp=read(pkg/'V1_26591_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
...
payload=pkg/'handoff_payload_26591_v1'
for r in CHANGED:
 src=payload/r
...
print('PASS exact successful 26590 compiled-candidate authority + five-file 26591 V1 payload overlay')
