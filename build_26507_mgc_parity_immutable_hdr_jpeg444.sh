...
pass "GATE 1 branch/lineage/exact 26506 backup/dependency hashes"
...
test -f "$THIRD/libjpeg-turbo/CMakeLists.txt"; test -f "$THIRD/libultrahdr/lib/include/ultrahdr_api.h"
