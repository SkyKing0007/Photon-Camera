...
import re,sys
if len(sys.argv)<3: raise SystemExit('usage: verify_26613_v1_1_infrastructure.py BUILD WORKFLOW [--success-26612-script P --success-26612-workflow P]')
...
assert 'e544a1a408d6dcda028c029dd4539ca4ded49f21' in b
...
assert 'build-26613-v1-1-fixed-domain-support-provenance.yml' in w
assert 'IrisCamera-${VERSION_NAME}-${VERSION_BUILD}-v1-1-fixed-domain-support-provenance-debug.apk' in b
assert 'IrisCamera-0.9726613-26613-v1-1-fixed-domain-support-provenance-debug.apk' in w
...
print('PASS 26613 V1.1 infrastructure: exact successful-26612 compiler/NDK/patch/PRE-BUILD/assemble/postbuild ordering preserved; identity/scope only; no backup')
