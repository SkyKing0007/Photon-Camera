...
for t in ['R1_2_BROKEN_COMMIT="9dc0efd79253f7d2caa016b763796bdd37621ec7"','R1_3_COMMIT="e6982a7eff421c2f7f8eda5bb142241465420f83"','git diff --name-only "$HANDOFF_PARENT_COMMIT"..HEAD','git diff --name-only "$R1_3_COMMIT"..HEAD','sealed runtime payload must contain exactly 18 files','R1.4 must change exactly 11 paths','snapshot_candidate_from_authority','verify_shaders','RUNTIME_AUTHORITY_COMMIT="e6790ebd2f2a8403191a276d659de4a708181efa"','FAILED_R1_COMMIT="a33e00935e00d7153cb72619333f658b0a5a566c"','R1_1_COMMIT="1f414a3d47d6de8baa507c8c293dabfc2d526d04"','SUCCESS_26635_BUILD_BLOB="779990cef8c143011e411ca87109e36d75875fa1"','SUCCESS_26635_WORKFLOW_BLOB="bb43c017494365bdccede14f2e388d156b22211e"','SUCCESS_26635_TRANSFORM_BLOB="fd466230a174cec21093c1eaba7da7585f418550"']:
...
print('PASS 26636 R1.4 infrastructure: exact successful-26635 ordering/isolation/Kotlin-Java/NDK/patch/PRE-BUILD/assemble/postbuild mechanics preserved; only direct-R1.3 topology and native dependency/ABI regressions resealed')
