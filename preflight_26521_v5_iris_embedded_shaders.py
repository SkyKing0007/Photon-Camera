...
def main():
    ...
    text=p.read_text()
    for marker in ('IRIS_26521_V4_DIRECTIONAL_GREEN','IRIS_26521_V4_ROBUST_SPATIAL_KERNEL','IRIS_26521_V4_ROBUST_COLOR_DIFFERENCE','IRIS_26520_V5_CONTINUOUS_FINEST_LK_TRANSPORT','IRIS_26521_V5_CORRECTED_SPATIAL_INFRASTRUCTURE'):
    ...
    total=0
    with tempfile.TemporaryDirectory(prefix='iris26521v5_glsl_') as td:
        td=Path(td)
        ...
        for version in (300,310):
            ...
            total+=1
    print(f'PASS: glslang compiled {total} Iris26521 V5 embedded runtime shader programs')
