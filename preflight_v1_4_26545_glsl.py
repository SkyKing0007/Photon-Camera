...
def run(root,validator=None):
    ...
    if validator:
        ...
        print(f'PASS: REAL GLSL COMPILE {len(sources)} V1.4 active/changed shaders via {validator}')
    print(f'PASS: 26545 V1.4 GLSL extraction/contracts shaders={len(sources)}')
def self_test():
    ...
    print('PASS: 26545 V1.4 GLSL preflight self-test')
