...
def main():
 ...
 pairs={
 'full':('V1_26588_BASE_26586_FULL_APP.sha256','V1_26588_EXPECTED_CANDIDATE_FULL_APP.sha256'),
 'protected':('V1_26588_PROTECTED_UNCHANGED_BASE.sha256','V1_26588_PROTECTED_UNCHANGED_CANDIDATE.sha256'),
 'native':('V1_26588_NATIVE_PROTECTED_BASE.sha256','V1_26588_NATIVE_PROTECTED_CANDIDATE.sha256'),
 'vendor':('V1_26588_VENDOR_PROTECTED_BASE.sha256','V1_26588_VENDOR_PROTECTED_CANDIDATE.sha256'),
 'dng':('V1_26588_DNG_PROTECTED_BASE.sha256','V1_26588_DNG_PROTECTED_CANDIDATE.sha256'),
 'arch':('V1_26588_PROTECTED_ARCHITECTURE_BASE.sha256','V1_26588_PROTECTED_ARCHITECTURE_CANDIDATE.sha256')}
 ...
 if verify(b,pkg/'V1_26588_PREWRITE_SOURCE_HASHES.sha256')!=6:fail('prewrite')
 if verify(c,pkg/'V1_26588_EXPECTED_CHANGED_SOURCE_HASHES.sha256')!=6:fail('changed')
 if (pkg/'V1_26588_RUNTIME_CHANGED_PATHS.txt').read_text().splitlines()!=CHANGED:fail('allowlist order/content')
