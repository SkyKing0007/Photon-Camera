...
pre=read(pkg/'V1_26600_PREWRITE_SOURCE_HASHES.sha256'); exp=read(pkg/'V1_26600_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
if list(pre)!=CHANGED or list(exp)!=CHANGED: fail('manifest allowlist mismatch')
payload=pkg/'handoff_payload_26600_v1'
...
print('PASS exact successful-26599 compiled-candidate authority + exact three-file 26600 V1 boundary-consensus SHORT geometry overlay')
