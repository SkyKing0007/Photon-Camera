...
import hashlib,sys
if len(sys.argv)!=3: raise SystemExit('usage: validate_26619_r1.py BASE CAND')
...
print('PASS 26619 semantic/ownership/domain validation: exact 13-path delta; defective 26618 pre-tone gain retired; final guided base/detail owner shared by 1x/true2x')
