...
CHANGED=[x for x in '''app/src/main/java/com/particlesdevs/photoncamera/processing/processor/PhotonMotionMgc1271Bridge.kt
...
def regen(a,b,abbr):
 td=Path(tempfile.mkdtemp(prefix='p26589v1_'))
 try:
  init(td,a)
...
def apply(a,b,p):
 td=Path(tempfile.mkdtemp(prefix='a26589v1_'))
 try:
