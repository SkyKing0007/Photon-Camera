...
public class RotateWatermark extends Node {
    ...
    public void Run() {
        ...
        try {
             ...
             * General > Watermark remains the sole enable authority. The old Photon asset and
             * external DCIM/PhotonCamera/Tuning watermark fallback are intentionally removed. */
            watermark = new GLImage(PhotonCamera.getAssetLoader().getInputStream(
                    "watermark/iris_camera_watermark.png"));
