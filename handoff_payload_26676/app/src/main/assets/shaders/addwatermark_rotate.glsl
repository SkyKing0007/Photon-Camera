...
void main() {
     ...
     * Final-raster normalized geometry only: 14.5% of final width, 1.2% safe inset, lower-right.
    ...
    float iris26676WmWidth = iris26676OutSize.x * 0.145;
    float iris26676WmHeight = iris26676WmWidth * (watersize.y / watersize.x);
    float iris26676Margin = max(2.0, min(iris26676OutSize.x, iris26676OutSize.y) * 0.012);
    float iris26676Left = iris26676OutSize.x - iris26676Margin - iris26676WmWidth;
    float iris26676Bottom = iris26676Margin;
    vec2 iris26676Frag = gl_FragCoord.xy;
    if (iris26676Frag.x >= iris26676Left
            && iris26676Frag.x <= iris26676Left + iris26676WmWidth
            && iris26676Frag.y >= iris26676Bottom
            && iris26676Frag.y <= iris26676Bottom + iris26676WmHeight) {
        vec2 iris26676Uv = vec2(
                (iris26676Frag.x - iris26676Left) / iris26676WmWidth,
                1.0 - (iris26676Frag.y - iris26676Bottom) / iris26676WmHeight);
        water = texture(Watermark, iris26676Uv);
