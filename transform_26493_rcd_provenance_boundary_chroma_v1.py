...
vec3 stabilizeHighlightBoundary(ivec2 lp,ivec2 gp,vec3 current){
    ...
    vec3 coherent=fromMeanOpponent(cm,guide);
    return mix(current,coherent,clamp(strength,0.0,0.64));
}
'''
    ...
    print('26493 TRANSFORM PASS files=2 V5B_RCD_CORE_UNCHANGED=true correction=finalWriteOnly')
