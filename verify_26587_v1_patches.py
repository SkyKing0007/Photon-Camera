...
CHANGED=[x for x in '''app/src/main/java/com/hinnka/mycamera/processor/RawStackContracts.kt
...
def regen(a,b,abbr):
 td=Path(tempfile.mkdtemp(prefix='p26587v1_'))
 try:
  init(td,a)
...
def apply(a,b,p):
 td=Path(tempfile.mkdtemp(prefix='a26587v1_'))
 try:
