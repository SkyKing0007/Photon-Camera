...
NEW_BUILD="26492"
OUTDIR="build_26492_v4_outputs"
APK_NAME="IrisCamera-${NEW_VERSION}-${NEW_BUILD}-v4-authority-provenance-r32f-debug.apk"
...
echo "=== 26492 V4 AUTHORITY / PROVENANCE CONTRACT — PROVEN R32F + EXACT TWO-WORKSPACE FINAL BUILD ==="
date -Iseconds || true
...
git merge-base --is-ancestor "$FAILED_V2_HEAD" HEAD || fail "26492 V4 must descend from the recorded V2 infrastructure checkpoint"
git merge-base --is-ancestor "$FAILED_V3_HEAD" HEAD || fail "26492 V4 must descend from the recorded V3 infrastructure checkpoint"
git merge-base --is-ancestor "$FAILED_26492_V1_HEAD" HEAD || fail "26492 V4 must descend from failed V1 infrastructure checkpoint"
...
26492 V4 Authority / Provenance Contract — R32F + Proven Two-Workspace Final Build
