...
def main():
    ...
    pre=read_manifest(root/'V1_26572_PREWRITE_SOURCE_HASHES.sha256')
    exp=read_manifest(root/'V1_26572_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
    payload=root/'handoff_payload_26572_v1'
    ...
    print('PASS deterministic candidate transform from exact successful 26571 compiled authority')
    print('PASS exact 5-file 26572 runtime payload applied candidate-first')
