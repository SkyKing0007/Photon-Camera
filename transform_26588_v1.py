...
pre=read(pkg/'V1_26588_PREWRITE_SOURCE_HASHES.sha256');exp=read(pkg/'V1_26588_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
...
payload=pkg/'handoff_payload_26588_v1'
for r in CHANGED:
 src=payload/r
...
print('PASS exact successful 26586 compiled-candidate authority + six-file 26588 V1 payload overlay')
