...
pre=read(pkg/'V1_26592_PREWRITE_SOURCE_HASHES.sha256');exp=read(pkg/'V1_26592_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
if list(pre)!=CHANGED or list(exp)!=CHANGED:fail('manifest allowlist mismatch')
payload=pkg/'handoff_payload_26592_v1'
...
print('PASS exact successful 26591 compiled-candidate authority + exact eight-file 26592 V1 HDR radiometric handoff overlay')
