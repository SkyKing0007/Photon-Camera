...
pre=read(pkg/'V1_26602_PREWRITE_SOURCE_HASHES.sha256'); exp=read(pkg/'V1_26602_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
if list(pre)!=CHANGED or list(exp)!=CHANGED: fail('manifest allowlist mismatch')
payload=pkg/'handoff_payload_26602_v1'
...
print('PASS exact successful-26601 compiled-candidate authority + exact six-file 26602 V1 full-protected bracket / UHDR-master SDR overlay')
