...
def main():
    ...
    specs=[
      ...
      ('sabre_sparse_flow_pure_geometry_26595',extract_kotlin(sc,'convertAlignmentSparse'),'frag'),
      ('short_region_seed_26595',extract_kotlin(sc,'shortRegionSeed26595'),'frag'),
      ('short_region_propagate_26594',extract_kotlin(sc,'shortRegionPropagate26594'),'frag'),
      ('short_sensor_loss_handoff_mask_26595',extract_kotlin(sc,'shortRestoreMask26595'),'frag'),
    ...
    sp=(root/'app/src/main/java/com/hinnka/mycamera/processor/GlesMgcRawSpatialShaders.kt').read_text(); specs.append(('short_full_mask_count_26595',extract_kotlin(sp,'bentoCountHighlightMask'),'comp'))
    ...
    (out/'V1_26595_RUNTIME_EXPANDED_SHADERS.sha256').write_text(''.join(manifest))
    (out/'V1_26595_SHADER_VERIFICATION.json').write_text(json.dumps(rows,indent=2)+'\n')
