...
pre=read(pkg/'V1_26599_PREWRITE_SOURCE_HASHES.sha256'); exp=read(pkg/'V1_26599_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
if list(pre)!=CHANGED or list(exp)!=CHANGED: fail('manifest allowlist mismatch')
payload=pkg/'handoff_payload_26599_v1'
...
print('PASS exact successful-26598 compiled-candidate authority + exact eight-file 26599 V1 effective-SHORT/shared-HDR-tone overlay')
