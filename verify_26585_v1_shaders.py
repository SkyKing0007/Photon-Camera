...
def main():
 ...
 # 26585 modifies the runtime asset shader used in two exact define variants.
 ...
 (out/'V1_26585_RUNTIME_EXPANDED_SHADERS.sha256').write_text(''.join(manifest))
 (out/'V1_26585_SHADER_VERIFICATION.json').write_text(json.dumps(rows,indent=2)+'\n')
