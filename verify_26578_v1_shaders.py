...
def main():
 ...
 specs=[
 ('vgn_universal_fail_closed_26578',extract_kotlin(vgn,'universalAdaptiveColor26561'),'comp',['IRIS_26578_FAIL_CLOSED_REAL_COLOR_GATE','neutralNeighborSupport','contourChainSupport','phaseLikeEvidence','realColorConfidence','falseColorGate','maximumMove','supportedTarget']),
 ...
 (out/'V1_26578_RUNTIME_EXPANDED_SHADERS.sha256').write_text(''.join(manifest))
 (out/'V1_26578_SHADER_VERIFICATION.json').write_text(json.dumps(rows,indent=2)+'\n')
 print('PASS exact runtime-expanded shader extraction + complete reserved scan variants=5')
