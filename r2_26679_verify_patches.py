...
if len(sys.argv)!=4: raise SystemExit('usage: r2_26679_verify_patches.py ROOT BASE CANDIDATE')
...
forward=make(base,cand);rollback=make(cand,base);f=root/'R2_26679_RUNTIME_DELTA_FROM_26678.patch';r=root/'R2_26679_RUNTIME_ROLLBACK_TO_26678.patch'
