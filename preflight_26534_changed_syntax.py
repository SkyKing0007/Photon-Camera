...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='iris26534-java-parse-') as td:
        td=Path(td); src=td/'ParseJava26534.java'; src.write_text(PARSER)
    ...
    if kotlinc:
        with tempfile.TemporaryDirectory(prefix='iris26534-kotlin-parse-') as td:
    ...
    print(f'PASS: 26534 javac parser accepted {len(JAVA)} changed Java files')
    print('PASS: 26534 Kotlin bridge lexical/grammar preflight accepted')
