...
def main():
    ...
    specs=[
      ...
      ('short_region_seed_26594',extract_kotlin(sc,'shortRegionSeed26594'),'frag'),
      ('short_region_propagate_26594',extract_kotlin(sc,'shortRegionPropagate26594'),'frag'),
      ('short_radiometric_handoff_mask_26594',extract_kotlin(sc,'shortRestoreMask26587'),'frag'),
    ...
    (out/'V1_26594_RUNTIME_EXPANDED_SHADERS.sha256').write_text(''.join(manifest))
    (out/'V1_26594_SHADER_VERIFICATION.json').write_text(json.dumps(rows,indent=2)+'\n')
    print('PASS 15 exact runtime-expanded shader variants + complete reserved identifier scan')
