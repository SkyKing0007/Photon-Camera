...
pre=read(pkg/'V1_26584_PREWRITE_SOURCE_HASHES.sha256');exp=read(pkg/'V1_26584_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
...
payload=pkg/'handoff_payload_26584_v1'
for r in CHANGED:
 src=payload/r
...
print('PASS exact successful 26583 V2 authority + three-file 26584 V1 payload overlay')
