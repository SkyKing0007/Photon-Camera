...
pre=read(pkg/'V1_26594_PREWRITE_SOURCE_HASHES.sha256');exp=read(pkg/'V1_26594_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
if list(pre)!=CHANGED or list(exp)!=CHANGED: fail('manifest allowlist mismatch')
payload=pkg/'handoff_payload_26594_v1'
...
print('PASS exact successful-26593 compiled-candidate authority + exact three-file 26594 region-anchored SHORT overlay')
