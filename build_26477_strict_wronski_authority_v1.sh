...
EXPECTED_INFRA_PARENT="e51a77a2c49282cd36e7a5503961b47c5fc60274"
...
TRANSFORM_SCRIPT="transform_26477_strict_wronski_authority.py"
...
exec > >(tee "$AUDIT") 2>&1
echo "=== 26477 STRICT WRONSKI RECONSTRUCTION AUTHORITY ==="
date -Iseconds || true

BRANCH="${GITHUB_REF_NAME:-$(git branch --show-current)}"
[[ "$BRANCH" == "$EXPECTED_BRANCH" ]] || fail "wrong branch: $BRANCH"
[[ "$(git rev-parse HEAD^)" == "$EXPECTED_INFRA_PARENT" ]] || fail "26477 infra parent is not exact 26476 V3"
