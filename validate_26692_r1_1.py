...
if len(sys.argv)!=3: raise SystemExit('usage: validate_26692_r1_1.py BASE CANDIDATE')
...
expected=[x for x in (pkg/'R1_1_26692_RUNTIME_CHANGED_PATHS.txt').read_text().splitlines() if x]
...
# Exact R1 compiler failure regression: RawFormat must resolve in modified Kotlin.
