...
internal object MgcFullResolutionDenoise {
    ...
    fun denoise(
        ...
        if (useSpatialModel) {
            ...
            // IRIS_26545_MEASURED_SABRE_RESIDUAL_NOISE
            // Sabre transports the measured post-merge Q8 average green-weight factor. Apply that
            // measured residual coefficient scale uniformly to the physical MGC-base read/shot
            // model. Do not apply the retired second reference-SNR lookup-table scale.
