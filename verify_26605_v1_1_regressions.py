...
def main():
 ...
 need(br,'PLog.i("MotionTrace", "PIPELINE_STATE stage=IRIS_26605_AUX_PHYSICAL_METADATA details=$details")','26605 V1.1 proven MotionTrace PLog telemetry');proc=(c/'app/src/main/java/com/hinnka/mycamera/processor/GlesIris26545SabreProcessor.kt').read_text()
