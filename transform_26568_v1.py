...
EXPECTED = {
    ...
    'app/src/main/java/com/hinnka/mycamera/processor/GlesMgcRawSpatialStacker.kt': ('a7743c18bf25fa2a5758b570288951c7654a317e7ec7f1131ee9bc32bce6e89e', '57c6d5aacd5114e87f5de3f80ca152c4d78a7f45609504e77599d93d7e78d918'),
...
def main():
    if len(sys.argv)!=2: fail('usage: transform_26568_v1.py CANDIDATE_ROOT')
    root=Path(sys.argv[1]).resolve()
    package=Path(__file__).resolve().parent
    payload=package/'handoff_payload_26568'
    ...
    print(f'PASS deterministic 26568 sealed transform changed_files={len(EXPECTED)}')
