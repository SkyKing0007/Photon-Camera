...
if len(sys.argv)!=4:raise SystemExit('usage: repair_26696_patches.py ROOT BASE26695 CANDIDATE')
base=Path(sys.argv[2]);cand=Path(sys.argv[3]);pkg=Path(__file__).resolve().parent;f=pkg/'26696_RUNTIME_DELTA_FROM_26695.patch';r=pkg/'26696_RUNTIME_ROLLBACK_TO_26695.patch'
...
print('PASS 26696 full-index patch proof: core.abbrev 7/12/40 identical, fuzz=0, exact forward+rollback including added runtime file')
