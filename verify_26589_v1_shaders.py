...
def main():
 ...
 if set(ec)!=set(eb):fail('successful 26588 embedded Sabre shader set changed')
 ...
 (out/'V1_26589_RUNTIME_EXPANDED_SHADERS.sha256').write_text(''.join(manifest));(out/'V1_26589_SHADER_VERIFICATION.json').write_text(json.dumps(rows,indent=2)+'\n')
 print('PASS all embedded Sabre shader strings byte-identical to successful 26588')
