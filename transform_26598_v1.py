...
pre=read(pkg/'V1_26598_PREWRITE_SOURCE_HASHES.sha256');exp=read(pkg/'V1_26598_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
if list(pre)!=CHANGED or list(exp)!=CHANGED: fail('manifest allowlist mismatch')
payload=pkg/'handoff_payload_26598_v1'
...
print('PASS exact successful-26597 compiled-candidate authority + exact six-file 26598 V1.1 scene-white/capture-ownership overlay')
