...
if len(sys.argv)!=3:raise SystemExit('usage: validate_26705.py BASE26704 CANDIDATE')
...
print('PASS validate 26705: exact 3-file scope; NORMAL AE untouched; no unconverged force latch; adaptive SHORT-only headroom; SHORT radiance highlight-only; successful 26704 tone/UHDR/Spektra/native protected')
