...
import math,sys
if len(sys.argv)!=3: raise SystemExit('usage: verify_26619_r1_regressions.py BASE CAND')
...
print(f'PASS 26619 regressions: exact 26618 ring failure reproduced plant={plant} chandelier={chand}; new full composition strictly monotonic/C1; detail residual exact; protected owners invariant')
