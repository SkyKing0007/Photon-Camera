...
WORK="/workspaces/Photon-Camera/build_26175_iris_camera_brand_ui_${STAMP}"
BACKUP_BRANCH="backup-before-iris-camera-brand-ui-26175-${STAMP}"
...
echo "============================================================"
echo " Iris Camera 0.9726175 — branding, launcher icon and final UI"
echo "============================================================"
