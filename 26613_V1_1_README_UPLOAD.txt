PHOTON / IRIS 26613 V1.1 — COMPILER-ONLY VISIBILITY REPAIR OVER FIXED-DOMAIN HDR + SABRE SUPPORT
...
Suggested commit:
  26613 V1.1 fixed-domain HDR and Sabre support provenance

V1.1 COMPILER-ONLY DELTA
- Exact V1 image math and 10-file runtime scope are preserved.
- Only runtime semantic difference from failed V1 candidate: MotionV2Render.IRIS_26613_SDR_KNEE_FINAL is public static final instead of package-private so MotionV2Jpeg444Encoder can legally read it across Java packages.
- No tone, UHDR, Sabre support, SHORT, CFA, Resolve, VGN, SR detail, DNG, capture, or preview math changes.
- Failed V1 commit e544a1a408d6dcda028c029dd4539ca4ded49f21 is handoff-parent only, never runtime authority.
