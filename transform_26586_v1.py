...
pre=read(pkg/'V1_26586_PREWRITE_SOURCE_HASHES.sha256');exp=read(pkg/'V1_26586_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
...
payload=pkg/'handoff_payload_26586_v1'
for r in CHANGED:
 src=payload/r
...
print('PASS exact successful 26585 V1 authority + two-file 26586 V1 payload overlay')
