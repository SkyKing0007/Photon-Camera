...
pre=read(pkg/'V1_26603_PREWRITE_SOURCE_HASHES.sha256'); exp=read(pkg/'V1_26603_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
if list(pre)!=CHANGED or list(exp)!=CHANGED: fail('manifest allowlist mismatch')
payload=pkg/'handoff_payload_26603_v1'
...
print('PASS exact successful-26602 compiled-candidate authority + exact six-file 26603 V1 one-tunnel bracket / master-faithful SDR overlay')
