...
pre=read(pkg/'V1_26596_PREWRITE_SOURCE_HASHES.sha256');exp=read(pkg/'V1_26596_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
if list(pre)!=CHANGED or list(exp)!=CHANGED: fail('manifest allowlist mismatch')
payload=pkg/'handoff_payload_26596_v1'
...
print('PASS exact successful-26595 compiled-candidate authority + exact eight-file 26596 SHORT/UHDR/SR overlay')
