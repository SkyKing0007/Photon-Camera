...
if len(sys.argv)!=4:raise SystemExit('usage: repair_26697_patches.py ROOT BASE26696R1 CANDIDATE')
base=Path(sys.argv[2]);cand=Path(sys.argv[3]);pkg=Path(__file__).resolve().parent;f=pkg/'26697_RUNTIME_DELTA_FROM_26696R1.patch';r=pkg/'26697_RUNTIME_ROLLBACK_TO_26696R1.patch'
...
with tempfile.TemporaryDirectory(prefix='i26697_') as td:
...
print('PASS 26697 full-index patch proof: core.abbrev 7/12/40 identical, fuzz=0, exact forward+rollback')
