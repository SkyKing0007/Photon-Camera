...
def main():
 ...
 specs=[
  ('vgn_universal_micro_object_26579',extract_kotlin(vgn,'universalAdaptiveColor26561'),'comp',['IRIS_26578_FAIL_CLOSED_REAL_COLOR_GATE','IRIS_26579_MICRO_OBJECT_COLOR_TOPOLOGY','microChromaWeight','microMinorMoment','microObjectProtection','falseColorGate','maximumMove']),
  ...
  ('true2x_topology_chroma_26579',extract_kotlin(sabre,'true2xGuideRender26568'),'frag',['IRIS_26579_TRUE2X_TOPOLOGY_CHROMA_UPSAMPLE','irisTopologyGuide','sameMaterial','maxChromaMagnitude','directChromaOwner'])
 ]
 ...
 specs[-1]=(specs[-1][0],specs[-1][1],specs[-1][2],['IRIS_26579_TRUE2X_TOPOLOGY_CHROMA_UPSAMPLE','irisTopologyGuide','sameMaterial','maxChromaMagnitude','bilinearY','confidence'])
 rows=[];manifest=[]
 ...
 (out/'V1_26579_RUNTIME_EXPANDED_SHADERS.sha256').write_text(''.join(manifest))
 (out/'V1_26579_SHADER_VERIFICATION.json').write_text(json.dumps(rows,indent=2)+'\n')
