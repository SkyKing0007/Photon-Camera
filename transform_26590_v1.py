...
pre=read(pkg/'V1_26590_PREWRITE_SOURCE_HASHES.sha256');exp=read(pkg/'V1_26590_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
...
payload=pkg/'handoff_payload_26590_v1'
for r in CHANGED:
 src=payload/r
...
print('PASS exact successful 26589 compiled-candidate authority + three-file 26590 V1 micro payload overlay')
