...
EXPECTED_INFRA_PARENT="c8beb8882370d66b85c5e3dbe13c69096aef5202"
EXPECTED_APP_BASE="8233415edf738bf35c0fe1c4907f5dfe51de31a4"

BACKUP_BRANCH="backup-26478-v6-before-26478-v7-scoped-diffcheck"
BACKUP_TARGET="c8beb8882370d66b85c5e3dbe13c69096aef5202"
...
exec > >(tee "$AUDIT") 2>&1
echo "=== 26478 V7 SCOPED-DIFFCHECK AUTHORITATIVE PURE WRONSKI + HIGHLIGHT-SAFE + SPEAKER DIAGNOSTIC ==="
date -Iseconds || true

BRANCH="${GITHUB_REF_NAME:-$(git branch --show-current)}"
[[ "$BRANCH" == "$EXPECTED_BRANCH" ]] || fail "wrong branch: $BRANCH"
[[ "$(git rev-parse HEAD^)" == "$EXPECTED_INFRA_PARENT" ]] || \
  fail "26478 V7 commit must be direct child of exact V6 infrastructure HEAD"
[[ "$(git rev-parse HEAD~2)" == "fbf480d37c5213f72697170ae356493570ab3cc4" ]] || \
  fail "26478 V7 chain missing exact V5 infrastructure HEAD"
[[ "$(git rev-parse HEAD~3)" == "87de69aff3d927be9c031c2fce476dffe88e4d71" ]] || \
  fail "26478 V7 chain missing exact V4 infrastructure HEAD"
[[ "$(git rev-parse HEAD~4)" == "62fed09aa61ac963f951fd39b1a62be870d75654" ]] || \
  fail "26478 V7 chain missing exact 62fed09 correction"
[[ "$(git rev-parse HEAD~5)" == "a5fa756f8b5cf1101e807b776728d08225f3e53e" ]] || \
  fail "26478 V7 chain missing exact first 26478 infrastructure commit"
[[ "$(git rev-parse HEAD~6)" == "be24c16cb091e753852b900384dbde6f8d32744e" ]] || \
  fail "26478 V7 chain must descend exactly from successful 26477 V3"
pass "branch/head exact six-commit infrastructure lineage gate"
...
cat > "$REPORT" <<EOF
26478 V7 SCOPED-DIFFCHECK AUTHORITATIVE PURE WRONSKI + HIGHLIGHT-SAFE + SPEAKER DIAGNOSTIC
========================================================================
Rollback:
