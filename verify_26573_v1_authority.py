...
def main():
 ...
 bf=pkg/'V1_26573_BASE_26572_FULL_APP.sha256';cf=pkg/'V1_26573_EXPECTED_CANDIDATE_FULL_APP.sha256'
 pb=pkg/'V1_26573_PROTECTED_UNCHANGED_BASE.sha256';pc=pkg/'V1_26573_PROTECTED_UNCHANGED_CANDIDATE.sha256'
 nb=pkg/'V1_26573_NATIVE_PROTECTED_BASE.sha256';nc=pkg/'V1_26573_NATIVE_PROTECTED_CANDIDATE.sha256'
 db=pkg/'V1_26573_DNG_PROTECTED_BASE.sha256';dc=pkg/'V1_26573_DNG_PROTECTED_CANDIDATE.sha256'
 ab=pkg/'V1_26573_PROTECTED_ARCHITECTURE_BASE.sha256';ac=pkg/'V1_26573_PROTECTED_ARCHITECTURE_CANDIDATE.sha256'
 pre=pkg/'V1_26573_PREWRITE_SOURCE_HASHES.sha256';ex=pkg/'V1_26573_EXPECTED_CHANGED_SOURCE_HASHES.sha256'
 ...
 changed=(pkg/'V1_26573_RUNTIME_CHANGED_PATHS.txt').read_text().splitlines()
 ...
 print(f'PASS exact 26572 compiled-candidate authority full={counts[0]} protected={counts[2]} nativeProtected={counts[4]} DNG={counts[6]} architecture={counts[8]}')
