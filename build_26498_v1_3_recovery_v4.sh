...
git fetch --quiet origin "$BACKUP_V13" "$BACKUP_26497" || fail "required runtime backup fetch failed"
...
echo "PASS: branch/lineage/dev protection and required runtime backups"
