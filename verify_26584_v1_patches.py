...
def regen(a,b,abbr):
 td=Path(tempfile.mkdtemp(prefix='p26584v1_'))
 try:
  init(td,a)
...
def apply(a,b,p):
 td=Path(tempfile.mkdtemp(prefix='a26584v1_'))
 try:
...
def main():
 ...
 print('PASS FORWARD PATCH FUZZ=0 exact 26584 recreation')
 print('PASS ROLLBACK PATCH FUZZ=0 exact successful 26583 recreation')
