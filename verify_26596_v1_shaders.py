...
def main():
    ...
    specs=[
      ...
      ('sabre_sparse_flow_pure_geometry_26596',extract_kotlin(sc,'convertAlignmentSparse'),'frag'),
      ...
      ('short_phase_complete_sensor_loss_handoff_mask_26596',extract_kotlin(sc,'shortRestoreMask26596'),'frag'),
    ...
    cpp=(root/'app/src/main/cpp/motionv2_jpeg444_jni.cpp').read_text(); specs.append(('true2x_publication_compute_26592',extract_cpp_raw(cpp,'kIris26571PublicationCompute'),'comp'))
    rows=[]; manifest=[]
    ...
    (out/'V1_26596_RUNTIME_EXPANDED_SHADERS.sha256').write_text(''.join(manifest))
    (out/'V1_26596_SHADER_VERIFICATION.json').write_text(json.dumps(rows,indent=2)+'\n')
