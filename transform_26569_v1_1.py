...
EXPECTED = {
    'app/src/main/cpp/motionv2_jpeg444_jni.cpp': ('e6f397e05f413743aaa5f2b1bd2963872ddfd0b5bae1f7941dd6467b53a6ab24', 'f9b3ab940676eb109d129f881bfb0f5971ae935d758377b9987ac4cdaf3f9e9f'),
...
def main():
    if len(sys.argv)!=2: fail('usage: transform_26569_v1_1.py CANDIDATE_ROOT')
    root=Path(sys.argv[1]).resolve()
    package=Path(__file__).resolve().parent
    payload=package/'handoff_payload_26569_v1_1'
    ...
    print(f'PASS deterministic 26569 V1.1 sealed transform changed_files={len(EXPECTED)}')
