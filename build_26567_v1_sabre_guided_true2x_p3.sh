...
verify_package(){
  ...
  [[ "$(sha "$CAND_PIN")" == "1b22d9090bed3ebad167f64ee0343ebcd99014d2e593c703b789314446094cc5" ]] || fail "candidate audited manifest SHA"
  [[ "$(sha "$BASE_FULL")" == "2b3ebde793a48527d21d9eabbcb14f3bb40d455f06aa3579e1f4985efd4744dd" ]] || fail "base full manifest SHA"
  [[ "$(sha "$CAND_FULL")" == "1c1a0eefd7de5f6f2b5f5e82d1724670291eef4b41f2073eab9d03a86dfa8dff" ]] || fail "candidate full manifest SHA"
  ...
  [[ "$(sha "$FORWARD")" == "bf03449eb07ce3d0cda2f5588af6ec578f3122cca004173efbedb4b88f97450f" ]] || fail "forward patch SHA"
  [[ "$(sha "$ROLLBACK")" == "55fac48509918126f153d1af70a26932b8314b2efc0501ea1443aa7eda88e9e6" ]] || fail "rollback patch SHA"
