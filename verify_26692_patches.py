...
if len(sys.argv)!=4: raise SystemExit('usage: verify_26692_patches.py ROOT BASE CANDIDATE')
root=Path(sys.argv[1]); base=Path(sys.argv[2]); cand=Path(sys.argv[3]); pkg=Path(__file__).resolve().parent
f=pkg/'R1_26692_RUNTIME_DELTA_FROM_26691_R1.patch'; r=pkg/'R1_26692_RUNTIME_ROLLBACK_TO_26691_R1.patch'
