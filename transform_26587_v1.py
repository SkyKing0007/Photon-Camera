...
pre=read(pkg/'V1_26587_PREWRITE_SOURCE_HASHES.sha256');exp=read(pkg/'V1_26587_EXPECTED_CHANGED_SOURCE_HASHES.sha256')
...
payload=pkg/'handoff_payload_26587_v1'
for r in CHANGED:
 src=payload/r
...
print('PASS exact successful 26586 compiled-candidate authority + six-file 26587 V1 payload overlay')
