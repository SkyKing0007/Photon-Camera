...
NEW_BUILD="26492"
OUTDIR="build_26492_v2_outputs"
APK_NAME="IrisCamera-${NEW_VERSION}-${NEW_BUILD}-v2-authority-provenance-r32f-debug.apk"
...
echo "=== 26492 V2 AUTHORITY / PROVENANCE CONTRACT — PROVEN R32F CARRIER ==="
date -Iseconds || true
...
git merge-base --is-ancestor "$FAILED_26492_V1_HEAD" HEAD || fail "26492 V2 must descend from failed V1 infrastructure checkpoint"
...
26492 V2 Authority / Provenance Contract — Proven R32F Carrier
