PHOTON / IRIS 26582 V2 — SCENE-ADAPTIVE GLOBAL TONE JAVA COMPILE FIX HANDOFF
...
V2 correction:
- fixes only the failed V1 Java call-site signature at candidate-meter sorting; tone math/ownership is otherwise unchanged.
- successful 26581 remains runtime and verification authority.
- failed V1 commit/run are regression evidence only, never candidate authority.
