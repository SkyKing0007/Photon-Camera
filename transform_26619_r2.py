...
if len(sys.argv)!=3: raise SystemExit('usage: transform_26619_r2.py BASE OUT')
...
def verify(root,manifest):
    ...
    return len(lines)
if verify(base,'R2_26619_PREWRITE_SOURCE_HASHES.sha256')!=11: raise SystemExit('prewrite count')
...
patch=P/'R2_26619_RUNTIME_DELTA_FROM_26618_R1.patch'
...
if verify(out,'R2_26619_EXPECTED_CHANGED_SOURCE_HASHES.sha256')!=10: raise SystemExit('candidate-present changed count')
