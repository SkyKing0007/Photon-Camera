...
PRE_MANIFEST_GATE_SHA="61988ef11c6cb73c9bfafe5334fd10659d2b1c5f"
BACKUP_MANIFEST_GATE="backup-26498-v1.3-module-fix-before-manifest-gate-fix"
...
git fetch --quiet origin "$BACKUP_V13" "$BACKUP_26497" "$BACKUP_MANIFEST_GATE" || fail "required backup fetch failed"
...
[[ "$(git rev-parse "origin/$BACKUP_MANIFEST_GATE")" == "$PRE_MANIFEST_GATE_SHA" ]] || fail "$BACKUP_MANIFEST_GATE does not point to pre-fix $PRE_MANIFEST_GATE_SHA"
...
[[ "$APK_BASENAME" == "IrisCamera-0.9726498-26498-debug.apk" ]] || \
