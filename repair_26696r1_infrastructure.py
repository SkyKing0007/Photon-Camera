...
if len(sys.argv)!=3:raise SystemExit('usage: repair_26696r1_infrastructure.py BUILD WORKFLOW')
...
marker='# IRIS_26696R1_AUTHORITATIVE_ACTIONS_STAGE_ORDER';assert s.count(marker)==1;main=s[s.index(marker):]
...
try:
 ...
 pass
print('PASS 26696 R1 infrastructure audit: exact successful 26695 build/workflow blobs pinned; compiler/build stage order unchanged; only explicit 26694 rollback-reference authority + 26696 identity/scope/regressions added')
