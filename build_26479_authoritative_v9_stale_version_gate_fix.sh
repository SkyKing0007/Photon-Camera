...
EXPECTED_INFRA_PARENT="fea487b2c9f6d41d630f78c8e4e1406ac3ccde7b"
EXPECTED_APP_BASE="8233415edf738bf35c0fe1c4907f5dfe51de31a4"

BACKUP_BRANCH="backup-26479-v8-before-v9-stale-version-gate-fix"
BACKUP_TARGET="fea487b2c9f6d41d630f78c8e4e1406ac3ccde7b"
...
exec > >(tee "$AUDIT") 2>&1
echo "=== 26479 V9 STALE-VERSION-GATE CORRECTION / ADRENO PORTABILITY ==="
date -Iseconds || true

BRANCH="${GITHUB_REF_NAME:-$(git branch --show-current)}"
[[ "$BRANCH" == "$EXPECTED_BRANCH" ]] || fail "wrong branch: $BRANCH"
[[ "$(git rev-parse HEAD^)" == "$EXPECTED_INFRA_PARENT" ]] || \
  fail "26479 V9 commit must be direct child of exact V8 infrastructure HEAD"
[[ "$(git rev-parse HEAD~2)" == "5755b1a05777423b5af9f803a57235ac73efdf68" ]] || \
  fail "26479 V9 chain missing exact successful V7 infrastructure HEAD"
[[ "$(git rev-parse HEAD~8)" == "be24c16cb091e753852b900384dbde6f8d32744e" ]] || \
  fail "26479 V9 chain must retain exact successful 26477 V3 ancestor"
pass "branch/head exact V9-on-V8 lineage gate"
