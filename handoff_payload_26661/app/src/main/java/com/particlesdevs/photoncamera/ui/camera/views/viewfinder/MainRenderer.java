...
public class MainRenderer implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public void onDrawFrame(GL10 unused) {
         ...
         * The repeating request is deliberately underexposed for RAW highlight safety. Restore
         * only that known capture bias in the displayed preview; this does not touch RAW/YUV
         * acquisition and therefore cannot become another exposure authority.
         */
        float iris26661ProtectionEv = 0.0f;
        CaptureController iris26661Controller = PhotonCamera.getCaptureController();
        if (iris26661Controller != null) {
            iris26661ProtectionEv = iris26661Controller.getMotion26661ReferencePreviewProtectionEv();
        }
        float iris26661PreviewGain = (float) Math.pow(2.0, iris26661ProtectionEv);
        GLES20.glUniform1f(iris26661ReferencePreviewGain, iris26661PreviewGain);
    ...
    private int iris26661ReferencePreviewGain;
    @Override
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        iris26661ReferencePreviewGain = GLES20.glGetUniformLocation(hProgram, "iris26661ReferencePreviewGain");
        GLES20.glVertexAttribPointer(vPosition, 2, GLES20.GL_FLOAT, false, 4 * 2, pVertex);
        GLES20.glVertexAttribPointer(vTexCoord, 2, GLES20.GL_FLOAT, false, 4 * 2, pTexCoord);
